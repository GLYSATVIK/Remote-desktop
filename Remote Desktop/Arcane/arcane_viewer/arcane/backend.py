...
class Session:
    def __init__(self, server_address: str, server_port: int, password: str) -> None:
        ...
        self.clipboard_mode = settings.value(arcane.SETTINGS_KEY_CLIPBOARD_MODE, ClipboardMode.Both)
        self.option_image_quality = settings.value(arcane.SETTINGS_KEY_IMAGE_QUALITY, 80)
        self.option_packet_size = settings.value(arcane.SETTINGS_KEY_PACKET_SIZE, PacketSize.Size4096)
