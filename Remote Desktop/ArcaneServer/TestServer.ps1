# cd Desktop\Arcane\Server\; IEX (Get-Content .\TestServer.ps1 -Raw -Encoding UTF8)
...
switch ($scenario)
{
    2 
    { 
        Invoke-ArcaneServer -Password $password -EncodedCertificate $pwdProtectedEncodedCertificate -CertificatePassword (ConvertTo-SecureString -String "hello" -AsPlainText -Force)
    } 

    3 
    {
        Invoke-ArcaneServer -Password $password
    }
    ...
    4 
    {
        ...
        Invoke-ArcaneServer -Password $password -UseTLSv1_3
    }
    ...
    5 
    {
        ...
        Invoke-ArcaneServer -Password $password -DisableVerbosity -ViewOnly -PreventComputerToSleep
    }
    ...
    6 
    {
        ...
        Invoke-ArcaneServer -Password $password -EncodedCertificate $encodedCertificate -Clipboard "Receive"
    }
    ...
    7 
    {
        ...
        Invoke-ArcaneServer -Password $password -EncodedCertificate $encodedCertificate -Clipboard "Send"
    }
    ...
    8 
    {
        ...
        Invoke-ArcaneServer -Password $password -EncodedCertificate $encodedCertificate -Clipboard "Disabled"
    }

    default 
    { 
        Invoke-ArcaneServer -SecurePassword (ConvertTo-SecureString -String $password -AsPlainText -Force) -EncodedCertificate $encodedCertificate
    }
} 